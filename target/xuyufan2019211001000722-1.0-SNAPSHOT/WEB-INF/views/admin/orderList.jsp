		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>order Date</td>
					<%
						com.xuyufan.model.Order o=(com.xuyufan.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.xuyufan.dao.UserDao userDao=new com.xuyufan.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.xuyufan.model.Payment.findByPaymentId(con,n);
						%>
